...
const insn_attr_t inat_primary_table[INAT_OPCODE_TABLE_SIZE] = {
        [0x00] = INAT_MODRM | INAT_BYTEOP,
        [0x01] = INAT_MODRM,
        [0x02] = INAT_MODRM | INAT_BYTEOP,
        [0x03] = INAT_MODRM,
        [0x04] = INAT_MAKE_IMM(INAT_IMM_BYTE) | INAT_BYTEOP,
        [0x05] = INAT_MAKE_IMM(INAT_IMM_VWORD32),
        [0x08] = INAT_MODRM | INAT_BYTEOP,
        [0x09] = INAT_MODRM,
        [0x0a] = INAT_MODRM | INAT_BYTEOP,
        [0x0b] = INAT_MODRM,
        [0x0c] = INAT_MAKE_IMM(INAT_IMM_BYTE) | INAT_BYTEOP,
        [0x0d] = INAT_MAKE_IMM(INAT_IMM_VWORD32),
        [0x0f] = INAT_MAKE_ESCAPE(1),
        [0x10] = INAT_MODRM | INAT_BYTEOP,
        [0x11] = INAT_MODRM,
        [0x12] = INAT_MODRM | INAT_BYTEOP,
        [0x13] = INAT_MODRM,
        [0x14] = INAT_MAKE_IMM(INAT_IMM_BYTE) | INAT_BYTEOP,
        [0x15] = INAT_MAKE_IMM(INAT_IMM_VWORD32),
        [0x18] = INAT_MODRM | INAT_BYTEOP,
        [0x19] = INAT_MODRM,
        [0x1a] = INAT_MODRM | INAT_BYTEOP,
        [0x1b] = INAT_MODRM,
        [0x1c] = INAT_MAKE_IMM(INAT_IMM_BYTE) | INAT_BYTEOP,
        [0x1d] = INAT_MAKE_IMM(INAT_IMM_VWORD32),
        [0x20] = INAT_MODRM | INAT_BYTEOP,
        [0x21] = INAT_MODRM,
        [0x22] = INAT_MODRM | INAT_BYTEOP,
        [0x23] = INAT_MODRM,
        [0x24] = INAT_MAKE_IMM(INAT_IMM_BYTE) | INAT_BYTEOP,
        [0x25] = INAT_MAKE_IMM(INAT_IMM_VWORD32),
        [0x26] = INAT_MAKE_PREFIX(INAT_PFX_ES),
        [0x28] = INAT_MODRM | INAT_BYTEOP,
        [0x29] = INAT_MODRM,
        [0x2a] = INAT_MODRM | INAT_BYTEOP,
        [0x2b] = INAT_MODRM,
        [0x2c] = INAT_MAKE_IMM(INAT_IMM_BYTE) | INAT_BYTEOP,
        [0x2d] = INAT_MAKE_IMM(INAT_IMM_VWORD32),
        [0x2e] = INAT_MAKE_PREFIX(INAT_PFX_CS),
        [0x30] = INAT_MODRM | INAT_BYTEOP,
        [0x31] = INAT_MODRM,
        [0x32] = INAT_MODRM | INAT_BYTEOP,
        [0x33] = INAT_MODRM,
        [0x34] = INAT_MAKE_IMM(INAT_IMM_BYTE) | INAT_BYTEOP,
        [0x35] = INAT_MAKE_IMM(INAT_IMM_VWORD32),
        [0x36] = INAT_MAKE_PREFIX(INAT_PFX_SS),
        [0x38] = INAT_MODRM | INAT_BYTEOP,
        [0x39] = INAT_MODRM,
        [0x3a] = INAT_MODRM | INAT_BYTEOP,
        [0x3b] = INAT_MODRM,
        [0x3c] = INAT_MAKE_IMM(INAT_IMM_BYTE) | INAT_BYTEOP,
        ...
        [0x6a] = INAT_MAKE_IMM(INAT_IMM_BYTE) | INAT_BYTEOP | INAT_FORCE64,
        [0x6b] = INAT_MAKE_IMM(INAT_IMM_BYTE) | INAT_MODRM,
        [0x70] = INAT_MAKE_IMM(INAT_IMM_BYTE) | INAT_BYTEOP,
        [0x71] = INAT_MAKE_IMM(INAT_IMM_BYTE) | INAT_BYTEOP,
        [0x72] = INAT_MAKE_IMM(INAT_IMM_BYTE) | INAT_BYTEOP,
        [0x73] = INAT_MAKE_IMM(INAT_IMM_BYTE) | INAT_BYTEOP,
        [0x74] = INAT_MAKE_IMM(INAT_IMM_BYTE) | INAT_BYTEOP,
        [0x75] = INAT_MAKE_IMM(INAT_IMM_BYTE) | INAT_BYTEOP,
        [0x76] = INAT_MAKE_IMM(INAT_IMM_BYTE) | INAT_BYTEOP,
        [0x77] = INAT_MAKE_IMM(INAT_IMM_BYTE) | INAT_BYTEOP,
        [0x78] = INAT_MAKE_IMM(INAT_IMM_BYTE) | INAT_BYTEOP,
        [0x79] = INAT_MAKE_IMM(INAT_IMM_BYTE) | INAT_BYTEOP,
        [0x7a] = INAT_MAKE_IMM(INAT_IMM_BYTE) | INAT_BYTEOP,
        [0x7b] = INAT_MAKE_IMM(INAT_IMM_BYTE) | INAT_BYTEOP,
        [0x7c] = INAT_MAKE_IMM(INAT_IMM_BYTE) | INAT_BYTEOP,
        [0x7d] = INAT_MAKE_IMM(INAT_IMM_BYTE) | INAT_BYTEOP,
        [0x7e] = INAT_MAKE_IMM(INAT_IMM_BYTE) | INAT_BYTEOP,
        [0x7f] = INAT_MAKE_IMM(INAT_IMM_BYTE) | INAT_BYTEOP,
        [0x80] = INAT_MAKE_IMM(INAT_IMM_BYTE) | INAT_MODRM | INAT_BYTEOP | INAT_MAKE_GROUP(1),
        [0x81] = INAT_MAKE_IMM(INAT_IMM_VWORD32) | INAT_MODRM | INAT_MAKE_GROUP(1),
        [0x82] = INAT_MAKE_IMM(INAT_IMM_BYTE) | INAT_MODRM | INAT_BYTEOP | INAT_MAKE_GROUP(1),
        [0x83] = INAT_MAKE_IMM(INAT_IMM_BYTE) | INAT_MODRM | INAT_MAKE_GROUP(1),
        [0x84] = INAT_MODRM | INAT_BYTEOP,
        [0x85] = INAT_MODRM,
        [0x86] = INAT_MODRM | INAT_BYTEOP,
        [0x87] = INAT_MODRM,
        [0x88] = INAT_MODRM | INAT_BYTEOP,
        [0x89] = INAT_MODRM,
        [0x8a] = INAT_MODRM | INAT_BYTEOP,
        [0x8b] = INAT_MODRM,
        [0x8c] = INAT_MODRM,
        [0x8d] = INAT_MODRM,
        [0x8e] = INAT_MODRM,
        ...
        [0x9c] = INAT_FORCE64,
        [0x9d] = INAT_FORCE64,
        [0xa0] = INAT_MOFFSET | INAT_BYTEOP,
        [0xa1] = INAT_MOFFSET,
        [0xa2] = INAT_MOFFSET | INAT_BYTEOP,
        [0xa3] = INAT_MOFFSET,
        [0xa4] = INAT_BYTEOP,
        [0xa6] = INAT_BYTEOP,
        [0xa8] = INAT_MAKE_IMM(INAT_IMM_BYTE) | INAT_BYTEOP,
        ...
        [0xc0] = INAT_MAKE_IMM(INAT_IMM_BYTE) | INAT_MODRM | INAT_BYTEOP | INAT_MAKE_GROUP(3),
        ...
        [0xc6] = INAT_MAKE_IMM(INAT_IMM_BYTE) | INAT_MODRM | INAT_BYTEOP | INAT_MAKE_GROUP(4),
        ...
        [0xcd] = INAT_MAKE_IMM(INAT_IMM_BYTE) | INAT_BYTEOP,
        [0xd0] = INAT_MODRM | INAT_MAKE_GROUP(3),
        [0xd1] = INAT_MODRM | INAT_MAKE_GROUP(3),
        [0xd2] = INAT_MODRM | INAT_BYTEOP | INAT_MAKE_GROUP(3),
        [0xd3] = INAT_MODRM | INAT_MAKE_GROUP(3),
        [0xd4] = INAT_MAKE_IMM(INAT_IMM_BYTE) | INAT_BYTEOP,
        [0xd5] = INAT_MAKE_IMM(INAT_IMM_BYTE) | INAT_BYTEOP,
        [0xd8] = INAT_MODRM,
        [0xd9] = INAT_MODRM,
        [0xda] = INAT_MODRM,
        [0xdb] = INAT_MODRM,
        ...
        [0xde] = INAT_MODRM,
        [0xdf] = INAT_MODRM,
        [0xe0] = INAT_MAKE_IMM(INAT_IMM_BYTE) | INAT_BYTEOP | INAT_FORCE64,
        [0xe1] = INAT_MAKE_IMM(INAT_IMM_BYTE) | INAT_BYTEOP | INAT_FORCE64,
        [0xe2] = INAT_MAKE_IMM(INAT_IMM_BYTE) | INAT_BYTEOP | INAT_FORCE64,
        [0xe3] = INAT_MAKE_IMM(INAT_IMM_BYTE) | INAT_BYTEOP | INAT_FORCE64,
        [0xe4] = INAT_MAKE_IMM(INAT_IMM_BYTE) | INAT_BYTEOP,
        [0xe5] = INAT_MAKE_IMM(INAT_IMM_BYTE),
        [0xe6] = INAT_MAKE_IMM(INAT_IMM_BYTE) | INAT_BYTEOP,
        ...
        [0xeb] = INAT_MAKE_IMM(INAT_IMM_BYTE) | INAT_BYTEOP | INAT_FORCE64,
        ...
        [0xf6] = INAT_MODRM | INAT_BYTEOP | INAT_MAKE_GROUP(6),
...
const insn_attr_t inat_escape_table_1[INAT_OPCODE_TABLE_SIZE] = {
        ...
        [0x90] = INAT_MODRM | INAT_BYTEOP | INAT_MODRM | INAT_VEXOK | INAT_VARIANT,
        [0x91] = INAT_MODRM | INAT_BYTEOP | INAT_MODRM | INAT_VEXOK | INAT_VARIANT,
        [0x92] = INAT_MODRM | INAT_BYTEOP | INAT_MODRM | INAT_VEXOK | INAT_VARIANT,
        [0x93] = INAT_MODRM | INAT_BYTEOP | INAT_MODRM | INAT_VEXOK | INAT_VARIANT,
        [0x94] = INAT_MODRM | INAT_BYTEOP,
        [0x95] = INAT_MODRM | INAT_BYTEOP,
        [0x96] = INAT_MODRM | INAT_BYTEOP,
        [0x97] = INAT_MODRM | INAT_BYTEOP,
        [0x98] = INAT_MODRM | INAT_BYTEOP | INAT_MODRM | INAT_VEXOK | INAT_VARIANT,
        [0x99] = INAT_MODRM | INAT_BYTEOP | INAT_MODRM | INAT_VEXOK | INAT_VARIANT,
        [0x9a] = INAT_MODRM | INAT_BYTEOP,
        [0x9b] = INAT_MODRM | INAT_BYTEOP,
        [0x9c] = INAT_MODRM | INAT_BYTEOP,
        [0x9d] = INAT_MODRM | INAT_BYTEOP,
        [0x9e] = INAT_MODRM | INAT_BYTEOP,
        [0x9f] = INAT_MODRM | INAT_BYTEOP,
        [0xa0] = INAT_FORCE64,
        [0xa1] = INAT_FORCE64,
        [0xa3] = INAT_MODRM,
...
const insn_attr_t inat_escape_table_3_1[INAT_OPCODE_TABLE_SIZE] = {
        ...
        [0x20] = INAT_MAKE_IMM(INAT_IMM_BYTE) | INAT_MODRM | INAT_BYTEOP | INAT_VEXOK,
...
const insn_attr_t inat_group_table_6[INAT_GROUP_TABLE_SIZE] = {
        [0x0] = INAT_MAKE_IMM(INAT_IMM_BYTE) | INAT_MODRM | INAT_BYTEOP,
        [0x2] = INAT_MODRM | INAT_BYTEOP,
        [0x3] = INAT_MODRM | INAT_BYTEOP,
        [0x4] = INAT_MODRM | INAT_BYTEOP,
        [0x5] = INAT_MODRM | INAT_BYTEOP,
        [0x6] = INAT_MODRM | INAT_BYTEOP,
        [0x7] = INAT_MODRM | INAT_BYTEOP,
};
...
const insn_attr_t inat_group_table_8[INAT_GROUP_TABLE_SIZE] = {
        [0x0] = INAT_MODRM | INAT_BYTEOP,
        [0x1] = INAT_MODRM | INAT_BYTEOP,
};
...
const insn_attr_t inat_group_table_4[INAT_GROUP_TABLE_SIZE] = {
        [0x0] = INAT_MAKE_IMM(INAT_IMM_BYTE) | INAT_MODRM | INAT_BYTEOP,
        [0x7] = INAT_MAKE_IMM(INAT_IMM_BYTE) | INAT_BYTEOP,
};
